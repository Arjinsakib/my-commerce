                        ...
                        <table id="myTable" class="table table-striped border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$order->customer->name?? 'None' .('.$order->customer->mobile.')}}</td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin.order.delete',['id'=> $order->id])}}" class="btn btn-danger btn-sm {{$order->order_status == "Cancel" ? 'btn btn-danger' : 'btn btn-danger disabled'}}" title="Delete Order" ">
                                            <i class="ti-trash"></i>
                                        </a>
                                    </td>
                                </tr>
