                ...
                <div class="card-body">
                    ...
                    <form action="{{route('sub-category.update',['id' => $sub_category->id])}}" method="POST" enctype="multipart/form-data" class="form-horizontal p-t-20">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 control-label">Category Name*<span class="text-denger"></span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="" class="col-sm-3 control-label">Sub Category Name*<span class="text-denger"></span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$sub_category->name}}" name="name" id="" placeholder="Sub Category Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="exampleInputEmail3" class="col-sm-3 control-label">Sub Category Description*<span class="text-denger"></span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <img src="{{asset($sub_category->image)}}" height="100" width="130">
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <label class="me-3"><input type="radio" {{$sub_category->status == 1 ? 'checked' : ''}} name="status" value="1">Published</label>
