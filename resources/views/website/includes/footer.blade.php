                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="index.html">
                                <h2 style="color: #67c7f3">eₐₛy sₕₒₚ</h2>
                            </a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-8 col-12">
                        ...
                        <div class="single-footer f-contact">
                            ...
                            <p class="phone">Phone: +880 1955904596</p>
                            <p class="mail">
                                <a
        ...
        <div class="container">
            <div class="inner-content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
                            <p>Designed and Developed by<a style="color: #67c7f3" href="#" rel="nofollow"
                                    target="_blank">Easy Shop</a></p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <ul class="socila">
