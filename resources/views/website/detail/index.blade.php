                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Brand
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group quantity">
                                            <input type="number" name="qty" class="form-control" value="1" min="1" placeholder="Produce Quantity">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="button cart-button">
                                                <button type="submit" href="" class="btn " style="width: 100%;">Add to Cart</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
